"""
Django settings for testembalae project.
...
ALLOWED_HOSTS = config(
    "ALLOWED_HOSTS",
    default="testembalae.fly.dev",
    cast=Csv(),
)

CSRF_TRUSTED_ORIGINS = config(
    "CSRF_TRUSTED_ORIGINS",
    default="https://testembalae.fly.dev",
    cast=Csv(),
)
...
ROOT_URLCONF = "testembalae.testembalae.urls"
...
WSGI_APPLICATION = "testembalae.testembalae.wsgi.application"
...
#             'filename': os.getenv('DJANGO_LOG_FILE', './testembalae.log'),
#             'formatter': 'simple'
#         },
#     },
#     'loggers': {
